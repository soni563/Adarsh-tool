...
def display_animated_logo():
    ...
    logo_lines = [
        ("$$$$$$$$\ $$$$$$\ $$$$$$\  $$$$$$\  $$$$$$$$\ $$$$$$$\  ", Fore.CYAN),
        ("\__$$  __|\_$$  _|\_$$  _|$$  __$$\ $$  _____|$$  __$$\ ", Fore.CYAN),
        ("   $$ |     $$ |    $$ |  $$ /  \__|$$ |      $$ |  $$ |", Fore.CYAN),
        ("   $$ |     $$ |    $$ |  $$ |$$$$\ $$$$$\    $$$$$$$  |", Fore.CYAN),
        ("   $$ |     $$ |    $$ |  $$ |\_$$ |$$  __|   $$  __$$< ", Fore.CYAN),
        ("   $$ |     $$ |    $$ |  $$ |  $$ |$$ |      $$ |  $$ |", Fore.CYAN),
        ("   $$ |   $$$$$$\ $$$$$$\ \$$$$$$  |$$$$$$$$\ $$ |  $$ |", Fore.CYAN),
        ("   \__|   \______|\______| \______/ \________|\__|  \__|", Fore.CYAN),
        ("                                                        ", Fore.CYAN),
        ("                                                        ", Fore.CYAN),

        ("         ╭────────────────────── < ~ MULTI     CONVO ~  > ────────────────────╮", Fore.CYAN),
        ("         │                                                                    │", Fore.YELLOW),
        ...
        ("║  FORM 🏠    : DELHII                                                                ║", Fore.CYAN),
        ("║  BRAND      : MULTI CONVO                                                           ║", Fore.GREEN),
        ("║  GitHub     : ADARSH                                                                ║", Fore.CYAN),                                                                          ("║  TOOL       : GROUP LOADER                                                          ║", Fore.GREEN),
        ("╚═════════════════════════════════════════════════════════════════════════════════════╝", Fore.YELLOW),
    ]
    ...
    typing_effect("             <<━━━━━━━━━━━━━━━━━━⏮️TIIGER TOOL⏭️━━━━━━━━━━━━━━━━━>>", 0.02, Fore.YELLOW)
    time.sleep(1)
